...
class DualListbox {
    ...
    setDefaults() {
        ...
        this.availableTitle = 'Danh Sách Cộng Đồng';
        this.selectedTitle = 'Cộng Đồng đã chọn';

        this.showAddButton = true;
        this.addButtonText = 'Thêm';

        this.showRemoveButton = true;
        this.removeButtonText = 'Loại';

        this.showAddAllButton = true;
        this.addAllButtonText = 'Thêm tất cả';

        this.showRemoveAllButton = true;
        this.removeAllButtonText = 'Loại tất cả';
