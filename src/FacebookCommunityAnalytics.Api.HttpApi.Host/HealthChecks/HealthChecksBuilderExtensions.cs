...
namespace FacebookCommunityAnalytics.Api.HealthChecks
{
    public static class HealthChecksBuilderExtensions
    {
        public static void AddApiHealthChecks(this IServiceCollection services)
        {
            ...
            healthChecksBuilder.AddCheck<ApiDatabaseCheck>("Api DbContext Check", tags: new string[] { "database" });
            ...
            {
                settings.AddHealthCheckEndpoint("Api Health Status", "/health-status");
            });
