...
{
    public class ApiTenantDatabaseMigrationHandler :
        ...
        ITransientDependency
    {
        ...
        private readonly ILogger<ApiTenantDatabaseMigrationHandler> _logger;

        public ApiTenantDatabaseMigrationHandler(
            IEnumerable<IApiDbSchemaMigrator> dbSchemaMigrators,
            ICurrentTenant currentTenant,
            IUnitOfWorkManager unitOfWorkManager,
            IDataSeeder dataSeeder,
            ITenantStore tenantStore,
            ILogger<ApiTenantDatabaseMigrationHandler> logger)
        {
        ...
        public async Task HandleEventAsync(TenantCreatedEto eventData)
        {
            await MigrateAndSeedForTenantAsync(
                eventData.Id,
                eventData.Properties.GetOrDefault("AdminEmail") ?? ApiConsts.AdminEmailDefaultValue,
                eventData.Properties.GetOrDefault("AdminPassword") ?? ApiConsts.AdminPasswordDefaultValue
            );
        }
        ...
        public async Task HandleEventAsync(TenantConnectionStringUpdatedEto eventData)
        {
            await MigrateAndSeedForTenantAsync(
                eventData.Id,
                ApiConsts.AdminEmailDefaultValue,
                ApiConsts.AdminPasswordDefaultValue
            );
