...
{
    public class InitPartnerUncrawledPostsJob : BackgroundJobBase
    {
        private readonly ICrawlDomainService _crawlDomainService;

        public InitPartnerUncrawledPostsJob(ICrawlDomainService crawlDomainService, ISmtpEmailSender emailSender, ITemplateRenderer templateRenderer) : base(emailSender, templateRenderer)
        {
