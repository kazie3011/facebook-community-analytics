...
namespace FacebookCommunityAnalytics.Api
{
    public class ApiApplicationAutoMapperProfile : Profile
    {
        public ApiApplicationAutoMapperProfile()
        {
            ...
            CreateMap<GroupStatsView, GroupStatsViewDto>();
            CreateMap<GroupCrawlInfo, GroupCrawlInfoDto>();
            CreateMap<TikTokTarget, TikTokTargetDto>().ReverseMap();
            ...
            CreateMap<ContractTransactionWithNavigationProperties, ContractTransactionWithNavigationPropertiesDto>();
            ...
            CreateMap<TiktokWithNavigationProperties, TiktokExportRow>()
                ...
                .ForMember(row => row.UID, opt => opt.MapFrom(src => src.Group.TikTokUserId))
            ...
            CreateMap<TiktokCreateUpdateDto, Tiktok>().Ignore(x => x.Id).IgnoreAuditedObjectProperties();

            CreateMap<TikTokMCN, TikTokMCNDto>().ReverseMap();
            CreateMap<MCNVietNamChannel, MCNVietNamChannelDto>().ReverseMap();
            CreateMap<CreateUpdateTikTokMCNDto, TikTokMCN>().Ignore(x=>x.Id).IgnoreAuditedObjectProperties();
            
            CreateMap<TrendingDetail, TrendingDetailDto>().ReverseMap();
            
            CreateMap<UserSalaryConfigurationNavigationProperties, UserSalaryConfigWithNavPropertiesDto>().ReverseMap();
            CreateMap<UserSalaryConfiguration, UserSalaryConfigurationDto>().ReverseMap();
            CreateMap<UpdateUserSalaryConfigurationDto, UserSalaryConfiguration>().ReverseMap();

            CreateMap<AutoPostFacebook, AutoPostFacebookDto>().ReverseMap();
            CreateMap<AutoPostFacebookNotDone, AutoPostFacebookNotDoneDto>().ReverseMap();
            CreateMap<CreateUpdateAutoPostFacebookDto, AutoPostFacebook>().Ignore(x => x.Id);
            CreateMap<GroupCost, GroupCostDto>().ReverseMap();
            CreateMap<GroupCostInfo, GroupCostInfoDto>().ReverseMap();
