...
namespace FacebookCommunityAnalytics.Api.Posts
{
    ...
    {
        [Required] public PostContentType PostContentType { get; set; } = ((PostContentType[])Enum.GetValues(typeof(PostContentType)))[1];
        [Required] public PostCopyrightType PostCopyrightType { get; set; } = ((PostCopyrightType[])Enum.GetValues(typeof(PostCopyrightType)))[0];
        ...
        [Required] public int ShareCount { get; set; }
        [Required] public int TotalCount { get; set; }
        public string Hashtag { get; set; }
        public string Fid { get; set; }
        public bool IsNotAvailable { get; set; }
        public bool IsValid { get; set; }
        [Required] public PostStatus Status { get; set; } = ((PostStatus[])Enum.GetValues(typeof(PostStatus)))[0];
